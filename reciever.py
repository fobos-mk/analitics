...
hostname = os.getenv('HOST')    # Ip сервера
port = 5672                     # Порт
...
def reciever():
    ...
    # parsingResult = parsing(json.loads(body))
    # resaultAnalytics = anal(parsingResult)
    # """Нужно вставить обработку обратной структуры"""
    # responce(parsing(body),hostname, ResponceQueue)
